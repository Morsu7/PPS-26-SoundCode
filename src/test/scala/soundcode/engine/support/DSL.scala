...
def e3 = Pattern.Atom(Sound.NoteInText(Note("e"), dummyPos))
def b6 = Pattern.Atom(Sound.NoteInText(Note("b"), dummyPos))
def a5 = Pattern.Atom(Sound.NoteInText(Note("a"), dummyPos))
